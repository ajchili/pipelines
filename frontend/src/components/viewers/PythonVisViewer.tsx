...
export interface PythonVisViewerConfig extends ViewerConfig {
  htmlContent: string;
  // TODO: determine other config variables
}

interface PythonVisViewerProps {
  configs: PythonVisViewerConfig[];
  maxDimension?: number;
}

class PythonVisViewer extends Viewer<PythonVisViewerProps, any> {
...
export default PythonVisViewer;